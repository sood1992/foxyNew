...
export default function CrewCheckout() {
  ...
  // Handle kit parameter - pre-load kit assets
  useEffect(() => {
  ...
  const loadKitAssets = async (kitId) => {
    try {
      const kitRes = await assetApi.getKit(kitId)
      if (kitRes.kit && kitRes.kit.asset_ids) {
        const kitAssets = kitRes.kit.asset_ids
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="input-field"
                  placeholder="e.g., Wedding - Sharma, Corporate Video"
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="input-field"
                  placeholder="e.g., Main camera setup, Audio recording, etc."
                />
              </div>
